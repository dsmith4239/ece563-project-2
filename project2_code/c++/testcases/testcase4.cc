...
int main(int argc, char **argv){
	...
	ooo->load_program("C:/Users/Smith/Desktop/NCSU/spring 23/ECE563/project/ece563-project-2/project2_code/c++/asm/code_ooo2.asm", 0x00000000); //ooo->load_program("asm/code_ooo2.asm", 0x00000000);
